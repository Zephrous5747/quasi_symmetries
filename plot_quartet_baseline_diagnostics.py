...
def main() -> None:
    ...
    parser.add_argument(
        "--csv",
        type=Path,
        default=Path("opt_results/h4_linear_quartet_baseline_summary.csv"),
        help="Quartet baseline summary CSV.",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("images/quartets/h4_linear_quartet_baseline_diagnostics.png"),
        help="Output figure path.",
    )
    parser.add_argument(
        "--fixed-abc-csv",
        type=Path,
        default=Path("tables/h4_linear_quasi_symmetry_fixed_abc.csv"),
