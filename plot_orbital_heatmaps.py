...
from hamiltonian_geometry import N2_REPRESENTATIVE_GRID, default_grid_for_molecule
...
from quartet_optimization_utils import quartet_parity_expectations, single_parity_expectations
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("images/orbital_heatmaps"),
    )
    parser.add_argument(
        "--molecule",
        choices=("h2o", "n2"),
