...
SYSTEMS = {
    "h4_linear": {
        ...
        "fixed_csv": Path("tables/h4_linear_quasi_symmetry_fixed_abc.csv"),
        "shared_csv": Path("tables/h4_linear_quasi_symmetry_shared_abc.csv"),
        "local_csv": Path("tables/h4_linear_quasi_symmetry_local_abc.csv"),
        "output": Path("images/quadratics/h4_linear_abc_diagnostics.png"),
        "scatter_output": Path("images/quadratics/h4_linear_commutator_scatter.png"),
    },
    "lih": {
        "label": "LiH",
        "x_label": r"Bond length $R$ ($\AA$)",
        "fixed_csv": Path("tables/lih_quasi_symmetry_fixed_abc.csv"),
        "shared_csv": Path("tables/lih_quasi_symmetry_shared_abc.csv"),
        "local_csv": Path("tables/lih_quasi_symmetry_local_abc.csv"),
        "output": Path("images/quadratics/lih_abc_diagnostics.png"),
        "scatter_output": Path("images/quadratics/lih_commutator_scatter.png"),
    },
    "h2o": {
        "label": "H2O",
        "x_label": r"O--H bond length scale",
        "fixed_csv": Path("tables/h2o_quasi_symmetry_fixed_abc.csv"),
        "shared_csv": Path("tables/h2o_quasi_symmetry_shared_abc.csv"),
        "local_csv": Path("tables/h2o_quasi_symmetry_local_abc.csv"),
        "output": Path("images/quadratics/h2o_abc_diagnostics.png"),
        "scatter_output": Path("images/quadratics/h2o_commutator_scatter.png"),
    },
}
...
def main() -> None:
    ...
    parser.add_argument(
        "--correlations-csv",
        type=Path,
        default=Path("tables/abc_system_commutator_correlations.csv"),
