...
from quartet_optimization_workflow import _load_ref


def main() -> None:
    source = Path("tables/h2o_quasi_symmetry_local_abc.csv")
    ...
    out_path = Path("opt_results/h2o_quartet_localabc_warmstart_smoke.csv")
